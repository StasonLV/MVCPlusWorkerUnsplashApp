...
class NetworkService {
    ...
    func randomPhotosRequest(completion: @escaping (Data?, Error?) -> Void)  {
        let parameters = self.prepareRandomPhotoParaments()
    ...
    private func prepareHeader() -> [String: String]? {
        ...
        headers["Authorization"] = "Client-ID ebqTZ8HUMZdY7DhSitfXx2XS9mF7AHeESqpeK3ZlEE4"
        return headers
    }
    ...
    private func prepareRandomPhotoParaments() -> [String: String] {
        var parameters = [String: String]()
        parameters["page"] = String(1)
        parameters["per_page"] = String(30)
        return parameters
